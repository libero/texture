...
import { TEXTURE_JATS_PUBLIC_ID, JATS_GREEN_1_1_PUBLIC_ID, JATS_GREEN_1_2_PUBLIC_ID } from './ArticleConstants';
...
export default {
  ...
  configure(config) {
    ...
    articleConfig.setValue(
      'figure-label-generator',
      new FigureLabelGenerator({
        singular: 'Figure $',
        plural: 'Figures $',
        and: ',',
        to: '-',
    ...
    articleConfig.setValue(
      'footnote-label-generator',
      new NumberedLabelGenerator({
        template: '$',
        and: ',',
        to: '-',
      }),
    ...
    articleConfig.setValue(
      'supplementary-file-label-generator',
      new NumberedLabelGenerator({
