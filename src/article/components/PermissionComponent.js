...
export default class PermissionComponent extends NodeComponent {
  render($$) {
    ...
    el.append(
      $$(FormRowComponent, { label: this.getLabel('copyrightStatement') })
        .attr('data-id', node.id)
        .addClass('sm-ref-contrib')
        .append(
    ...
    el.append(
      $$(FormRowComponent, { label: this.getLabel('copyrightYear') })
        .attr('data-id', node.id)
        .addClass('sm-ref-contrib')
        .append(
    ...
    el.append(
      $$(FormRowComponent, { label: this.getLabel('copyrightHolder') })
        .attr('data-id', node.id)
        .addClass('sm-ref-contrib')
        .append(
    ...
    el.append(
      $$(FormRowComponent, { label: this.getLabel('licenseText') })
        .attr('data-id', node.id)
        .addClass('sm-ref-contrib')
        .append(
    ...
    el.append(
      $$(FormRowComponent, { label: this.getLabel('license') })
        .attr('data-id', node.id)
        .addClass('sm-ref-contrib')
        .append(
