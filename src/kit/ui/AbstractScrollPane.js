import { Component, platform, getSelectionRect, getRelativeMouseBounds, getRelativeRect } from 'substance';
...
export default class AbstractScrollPane extends Component {
  ...
  */
  ...
  _scrollRectIntoView(rect) {
    ...
    if ((selTop < upperBound && selBottom < upperBound) || (selTop > lowerBound && selBottom > lowerBound)) {
